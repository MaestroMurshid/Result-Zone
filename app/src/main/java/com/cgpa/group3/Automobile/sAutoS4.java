...
public class sAutoS4 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_autos4);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S4").child("4051").getValue() != null
                    ...
                    String sub2 = dataSnapshot.child(reg_no).child("S4").child("4053").getValue().toString();
                    int sub2cp = Calc(sub2);
                    Log.d(TAG, "Sub2cp" + sub2cp + sub2);
                    String sub3 = dataSnapshot.child(reg_no).child("S4").child("4052").getValue().toString();
                    ...
                    String sub5 = dataSnapshot.child(reg_no).child("S4").child("4059").getValue().toString();
                    int sub5cp = Calc(sub5);
                    Log.d(TAG, "Sub5cp" + sub5cp + sub5);
                    String sub6 = dataSnapshot.child(reg_no).child("S4").child("4058").getValue().toString();
                    int sub6cp = Calc(sub6);
                    Log.d(TAG, "Sub6cp" + sub6cp + sub6);
                    String sub7 = dataSnapshot.child(reg_no).child("S4").child("4056").getValue().toString();
                    int sub7cp = Calc(sub7);
                    String sub8 = dataSnapshot.child(reg_no).child("S4").child("4057").getValue().toString();
                    int sub8cp = Calc(sub8);

                    String cp1 = dataSnapshot.child("Credits4").child("4051").getValue().toString();
                    String cp2 = dataSnapshot.child("Credits4").child("4053").getValue().toString();
                    String cp3 = dataSnapshot.child("Credits4").child("4052").getValue().toString();
                    String cp4 = dataSnapshot.child("Credits4").child("4055").getValue().toString();
                    String cp5 = dataSnapshot.child("Credits4").child("4059").getValue().toString();
                    String cp6 = dataSnapshot.child("Credits4").child("4058").getValue().toString();
                    String cp7 = dataSnapshot.child("Credits4").child("4056").getValue().toString();
                    String cp8 = dataSnapshot.child("Credits4").child("4057").getValue().toString();
