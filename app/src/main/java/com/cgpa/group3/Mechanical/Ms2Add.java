...
public class Ms2Add extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ms2_add);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Grades.contains(s1) && Grades.contains(s2) && Grades.contains(s3) && Grades.contains(s4) && Grades.contains(s5) && Grades.contains(s6)&& Grades.contains(s7)&& Grades.contains(s8)&& Grades.contains(s9)&& Grades.contains(s10)) {
                    Log.d(TAG, "Inside");
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c1).setValue(s1);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c2).setValue(s2);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c3).setValue(s3);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c4).setValue(s4);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c5).setValue(s5);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c6).setValue(s6);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c7).setValue(s7);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c8).setValue(s8);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c9).setValue(s9);
                    database.child("Result").child("Mechanical").child(reg_no).child("S2").child(c10).setValue(s10);
