...
public class CiviladdStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civil_add_student);
        ...
        database1 = FirebaseDatabase.getInstance().getReference().child("Student").child("civil");
    }
    ...
    public void submit(View view){
        ...
        database.child(students.getReg_no()).setValue(students).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    database.child(Regi_no).child("Department").setValue("civil");
                    Toast.makeText(CiviladdStudent.this, "Student Registered Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), CivilStudents.class));
                }
                else{
                    Toast.makeText(CiviladdStudent.this, "Registration Unsuccessful", Toast.LENGTH_SHORT).show();
                }
            }
        });
