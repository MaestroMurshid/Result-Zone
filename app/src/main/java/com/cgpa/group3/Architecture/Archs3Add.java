...
public class Archs3Add extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archs3_add);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S3").child("3001").getValue() != null && dataSnapshot.child(reg_no).child("S3").child("3011").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3013").getValue() !=null && dataSnapshot.child(reg_no).child("S3").child("3181").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3182").getValue() !=null && dataSnapshot.child(reg_no).child("S3").child("3183").getValue() !=null
                    ...
                    String sub3 = dataSnapshot.child(reg_no).child("S3").child("3013").getValue().toString();
                    ...
                    String sub5 = dataSnapshot.child(reg_no).child("S3").child("3182").getValue().toString();
                    ...
                    String cp3 = dataSnapshot.child("CreditS3").child("3013").getValue().toString();
                    String cp4 = dataSnapshot.child("CreditS3").child("3181").getValue().toString();
                    String cp5 = dataSnapshot.child("CreditS3").child("3182").getValue().toString();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Grades.contains(s1) && Grades.contains(s2) && Grades.contains(s3) && Grades.contains(s4) && Grades.contains(s5) && Grades.contains(s6)&& Grades.contains(s7)&& Grades.contains(s8)) {
                    Log.d(TAG, "Inside");
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c1).setValue(s1);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c2).setValue(s2);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c3).setValue(s3);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c4).setValue(s4);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c5).setValue(s5);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c6).setValue(s6);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c7).setValue(s7);
                    database.child("Result").child("Architecture").child(reg_no).child("S3").child(c8).setValue(s8);
