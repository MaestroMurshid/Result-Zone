...
public class EEEs2Calc extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eees2_calc);
            ...
            public void onClick(View v) {
                root.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String cp9 = dataSnapshot.child("CreditS2").child("2031").getValue().toString();
                        String cp10 = dataSnapshot.child("CreditS2").child("2039").getValue().toString();
