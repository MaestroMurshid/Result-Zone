...
public class Civils2Add extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civils2_add);
        ...
        database.child("Result").child("civil").child(reg_no).child("S2");
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S2").child("2001").getValue() != null && dataSnapshot.child(reg_no).child("S2").child("2002").getValue() !=null
                        ...
                        && dataSnapshot.child(reg_no).child("S2").child("2011").getValue() !=null && dataSnapshot.child(reg_no).child("S2").child("2019").getValue() !=null
                    ...
                    String sub5 = dataSnapshot.child(reg_no).child("S2").child("2011").getValue().toString();
                    ...
                    String sub9 = dataSnapshot.child(reg_no).child("S2").child("2019").getValue().toString();
                    ...
                    String cp5 = dataSnapshot.child("CreditS2").child("2011").getValue().toString();
                    ...
                    String cp9 = dataSnapshot.child("CreditS2").child("2019").getValue().toString();
                    ...
                    if (sub1cp >= 0 && sub2cp >= 0 && sub3cp >= 0 && sub4cp >= 0 && sub5cp >= 0 && sub6cp >= 0 && sub7cp>=0 && sub8cp>=0 && sub9cp>=0 && sub10cp>=0) {
                        ...
                        database.child("Result").child("civil").child(reg_no).child("S2").child("ttlsscore").setValue(ttl_score);

                        database.child("Result").child("civil").child(reg_no).child("S2").child("SGPA").setValue(finalresult);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Grades.contains(s1) && Grades.contains(s2) && Grades.contains(s3) && Grades.contains(s4) && Grades.contains(s5) && Grades.contains(s6)&& Grades.contains(s7)&& Grades.contains(s8)&& Grades.contains(s9)&& Grades.contains(s10)) {
                    Log.d(TAG, "Inside");
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c1).setValue(s1);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c2).setValue(s2);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c3).setValue(s3);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c4).setValue(s4);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c5).setValue(s5);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c6).setValue(s6);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c7).setValue(s7);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c8).setValue(s8);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c9).setValue(s9);
                    database.child("Result").child("civil").child(reg_no).child("S2").child(c10).setValue(s10);
