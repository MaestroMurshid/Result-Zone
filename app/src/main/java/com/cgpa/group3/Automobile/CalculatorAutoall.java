...
public class CalculatorAutoall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculator_auto_all);
        ...
        sem1button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorAutoall.this, Autos1Calc.class);
        ...
        sem2button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorAutoall.this, Autos2Calc.class);
        ...
        sem3button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorAutoall.this, Autos3Calc.class);
        ...
        sem4button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorAutoall.this, Autos4Calc.class);
        ...
        sem5button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorAutoall.this, Autos5Calc.class);
        ...
        sem6button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorAutoall.this, Autos6Calc.class);
