...
public class sArchS4 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_archs4);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S4").child("4014").getValue() != null
                    ...
                    String sub2 = dataSnapshot.child(reg_no).child("S4").child("4183").getValue().toString();
                    int sub2cp = Calc(sub2);
                    Log.d(TAG, "Sub2cp" + sub2cp + sub2);
                    String sub3 = dataSnapshot.child(reg_no).child("S4").child("4181").getValue().toString();
                    int sub3cp = Calc(sub3);
                    Log.d(TAG, "Sub3cp" + sub3cp + sub3);
                    String sub4 = dataSnapshot.child(reg_no).child("S4").child("4182").getValue().toString();
                    ...
                    String cp2 = dataSnapshot.child("CreditS4").child("4183").getValue().toString();
                    String cp3 = dataSnapshot.child("CreditS4").child("4181").getValue().toString();
                    String cp4 = dataSnapshot.child("CreditS4").child("4182").getValue().toString();
