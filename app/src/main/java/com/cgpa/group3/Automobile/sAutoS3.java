...
public class sAutoS3 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_autos3);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S3").child("3021").getValue() != null && dataSnapshot.child(reg_no).child("S3").child("3052").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3051").getValue() !=null && dataSnapshot.child(reg_no).child("S3").child("3001").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3024").getValue() !=null && dataSnapshot.child(reg_no).child("S3").child("3059").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3057").getValue() !=null&& dataSnapshot.child(reg_no).child("S3").child("3058").getValue() !=null

                ) {
                    String sub1 = dataSnapshot.child(reg_no).child("S3").child("3021").getValue().toString();
                    int sub1cp = Calc(sub1);
                    Log.d(TAG, "Sub1cp" + sub1cp + sub1);
                    String sub2 = dataSnapshot.child(reg_no).child("S3").child("3052").getValue().toString();
                    int sub2cp = Calc(sub2);
                    Log.d(TAG, "Sub2cp" + sub2cp + sub2);
                    String sub3 = dataSnapshot.child(reg_no).child("S3").child("3051").getValue().toString();
                    int sub3cp = Calc(sub3);
                    Log.d(TAG, "Sub3cp" + sub3cp + sub3);
                    String sub4 = dataSnapshot.child(reg_no).child("S3").child("3001").getValue().toString();
                    ...
                    String sub6 = dataSnapshot.child(reg_no).child("S3").child("3059").getValue().toString();
                    int sub6cp = Calc(sub6);
                    Log.d(TAG, "Sub6cp" + sub6cp + sub6);
                    String sub7 = dataSnapshot.child(reg_no).child("S3").child("3057").getValue().toString();
                    int sub7cp = Calc(sub7);
                    String sub8 = dataSnapshot.child(reg_no).child("S3").child("3058").getValue().toString();
                    int sub8cp = Calc(sub8);

                    String cp1 = dataSnapshot.child("CreditS3").child("3021").getValue().toString();
                    String cp2 = dataSnapshot.child("CreditS3").child("3052").getValue().toString();
                    String cp3 = dataSnapshot.child("CreditS3").child("3051").getValue().toString();
                    String cp4 = dataSnapshot.child("CreditS3").child("3001").getValue().toString();
                    String cp5 = dataSnapshot.child("CreditS3").child("3024").getValue().toString();
                    String cp6 = dataSnapshot.child("CreditS3").child("3059").getValue().toString();
                    String cp7 = dataSnapshot.child("CreditS3").child("3057").getValue().toString();
                    String cp8 = dataSnapshot.child("CreditS3").child("3058").getValue().toString();
