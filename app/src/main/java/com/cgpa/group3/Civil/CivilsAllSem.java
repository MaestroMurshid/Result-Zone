...
public class CivilsAllSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civils_all_sem);
        ...
        sem1button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String reg = reg_no;
                Intent intent = new Intent(CivilsAllSem.this, Civils1Add.class);
        ...
        sem2button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(CivilsAllSem.this, Civils2Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem3button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(CivilsAllSem.this, Civils3Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem4button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(CivilsAllSem.this, Civils4Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem5button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(CivilsAllSem.this, Civils5Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem6button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(CivilsAllSem.this, Civils6Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
