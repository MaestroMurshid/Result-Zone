...
public class Autos6Add extends AppCompatActivity{
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_autos6_add);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Grades.contains(s1) && Grades.contains(s2) && Grades.contains(s3) && Grades.contains(s4) && Grades.contains(s5) && Grades.contains(s6)&& Grades.contains(s7)) {
                    Log.d(TAG, "Inside");
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c1).setValue(s1);
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c2).setValue(s2);
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c3).setValue(s3);
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c4).setValue(s4);
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c5).setValue(s5);
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c6).setValue(s6);
                    database.child("Result").child("Automobile").child(reg_no).child("S6").child(c7).setValue(s7);
