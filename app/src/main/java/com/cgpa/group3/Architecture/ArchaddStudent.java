...
public class ArchaddStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arch_add_student);
        ...
        database1 = FirebaseDatabase.getInstance().getReference().child("Student").child("Architecture");
    }
    ...
    public void submit(View view){
        ...
        database.child(students.getReg_no()).setValue(students).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    database.child(Regi_no).child("Department").setValue("Architecture");
                    Toast.makeText(ArchaddStudent.this, "Student Registered Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), ArchitectureStudents.class));
                }
                else{
                    Toast.makeText(ArchaddStudent.this, "Registration Unsuccessful", Toast.LENGTH_SHORT).show();
                }
            }
        });
