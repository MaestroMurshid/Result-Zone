...
public class sArchS2 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_archs2);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S2").child("2001").getValue() != null && dataSnapshot.child(reg_no).child("S2").child("2002").getValue() !=null
                    ...
                    String sub5 = dataSnapshot.child(reg_no).child("S2").child("2181").getValue().toString();
                    ...
                    String sub9 = dataSnapshot.child(reg_no).child("S2").child("2189").getValue().toString();
                    ...
                    String cp5 = dataSnapshot.child("CreditS2").child("2181").getValue().toString();
                    ...
                    String cp9 = dataSnapshot.child("CreditS2").child("2189").getValue().toString();
