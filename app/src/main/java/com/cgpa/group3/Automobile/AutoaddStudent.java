...
public class AutoaddStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_add_student);
        ...
        database1 = FirebaseDatabase.getInstance().getReference().child("Student").child("Automobile");
    }
    ...
    public void submit(View view){
        ...
        database.child(students.getReg_no()).setValue(students).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    database.child(Regi_no).child("Department").setValue("Automobile");
                    Toast.makeText(AutoaddStudent.this, "Student Registered Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), AutomobileStudents.class));
                }
                else{
                    Toast.makeText(AutoaddStudent.this, "Registration Unsuccessful", Toast.LENGTH_SHORT).show();
                }
            }
        });
