...
public class AutosAllSem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_autos_all_sem);
        ...
        sem1button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String reg = reg_no;
                Intent intent = new Intent(AutosAllSem.this, Autos1Add.class);
        ...
        sem2button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(AutosAllSem.this, Autos2Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem3button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(AutosAllSem.this, Autos3Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem4button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(AutosAllSem.this, Autos4Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem5button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(AutosAllSem.this, Autos5Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
        ...
        sem6button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String reg = reg_no;
                Intent intent = new Intent(AutosAllSem.this, Autos6Add.class);
                intent.putExtra("reg_no", reg);
                intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
