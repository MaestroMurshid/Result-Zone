...
public class Es3Add extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_es3_add);
        ...
        database.child("Result").child("Electrical").child(reg_no).child("S3");

        root.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S3").child("3001").getValue() != null && dataSnapshot.child(reg_no).child("S3").child("3031").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3032").getValue() !=null && dataSnapshot.child(reg_no).child("S3").child("3033").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3034").getValue() !=null && dataSnapshot.child(reg_no).child("S3").child("3037").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S3").child("3038").getValue() !=null&& dataSnapshot.child(reg_no).child("S3").child("3039").getValue() !=null

                ) {
                    String sub1 = dataSnapshot.child(reg_no).child("S3").child("3033").getValue().toString();
                    int sub1cp = Calc(sub1);
                    Log.d(TAG, "Sub1cp" + sub1cp + sub1);
                    String sub2 = dataSnapshot.child(reg_no).child("S3").child("3034").getValue().toString();
                    int sub2cp = Calc(sub2);
                    Log.d(TAG, "Sub2cp" + sub2cp + sub2);
                    String sub3 = dataSnapshot.child(reg_no).child("S3").child("3031").getValue().toString();
                    int sub3cp = Calc(sub3);
                    Log.d(TAG, "Sub3cp" + sub3cp + sub3);
                    String sub4 = dataSnapshot.child(reg_no).child("S3").child("3032").getValue().toString();
                    ...
                    String sub6 = dataSnapshot.child(reg_no).child("S3").child("3038").getValue().toString();
                    int sub6cp = Calc(sub6);
                    Log.d(TAG, "Sub6cp" + sub6cp + sub6);
                    String sub7 = dataSnapshot.child(reg_no).child("S3").child("3037").getValue().toString();
                    int sub7cp = Calc(sub7);
                    String sub8 = dataSnapshot.child(reg_no).child("S3").child("3039").getValue().toString();
                    int sub8cp = Calc(sub8);

                    String cp1 = dataSnapshot.child("CreditS3").child("3033").getValue().toString();
                    String cp2 = dataSnapshot.child("CreditS3").child("3034").getValue().toString();
                    String cp3 = dataSnapshot.child("CreditS3").child("3031").getValue().toString();
                    String cp4 = dataSnapshot.child("CreditS3").child("3032").getValue().toString();
                    String cp5 = dataSnapshot.child("CreditS3").child("3001").getValue().toString();
                    String cp6 = dataSnapshot.child("CreditS3").child("3038").getValue().toString();
                    String cp7 = dataSnapshot.child("CreditS3").child("3037").getValue().toString();
                    ...
                    if (sub1cp >= 0 && sub2cp >= 0 && sub3cp >= 0 && sub4cp >= 0 && sub5cp >= 0 && sub6cp >= 0 && sub7cp>=0 && sub8cp>=0) {
                        ...
                        database.child("Result").child("Electrical").child(reg_no).child("S3").child("ttlsscore").setValue(ttl_score);

                        database.child("Result").child("Electrical").child(reg_no).child("S3").child("SGPA").setValue(finalresult);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Grades.contains(s1) && Grades.contains(s2) && Grades.contains(s3) && Grades.contains(s4) && Grades.contains(s5) && Grades.contains(s6)&& Grades.contains(s7)&& Grades.contains(s8)) {
                    Log.d(TAG, "Inside");
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c1).setValue(s1);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c2).setValue(s2);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c3).setValue(s3);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c4).setValue(s4);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c5).setValue(s5);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c6).setValue(s6);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c7).setValue(s7);
                    database.child("Result").child("Electrical").child(reg_no).child("S3").child(c8).setValue(s8);
