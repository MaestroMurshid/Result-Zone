...
public class CalculatorArchall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculator_arch_all);
        ...
        sem1button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorArchall.this, Archs1Calc.class);
        ...
        sem2button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorArchall.this, Archs2Calc.class);
        ...
        sem3button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorArchall.this, Archs3Calc.class);
        ...
        sem4button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorArchall.this, Archs4Calc.class);
        ...
        sem5button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorArchall.this, Archs5Calc.class);
        ...
        sem6button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CalculatorArchall.this, Archs6Calc.class);
