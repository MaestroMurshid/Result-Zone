...
public class Ms6Add extends AppCompatActivity{
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ms6_add);
        ...
        database.child("Result").child("Mechanical").child(reg_no).child("S6");
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(reg_no).child("S6").child("6009").getValue() != null
                        ...
                        && dataSnapshot.child(reg_no).child("S6").child("6021").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S6").child("6022").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S6").child("6023").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S6").child("6027").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S6").child("6028").getValue() !=null
                        && dataSnapshot.child(reg_no).child("S6").child("6029").getValue() !=null
                    ...
                    String sub3 = dataSnapshot.child(reg_no).child("S6").child("6021").getValue().toString();
                    int sub3cp = Calc(sub3);
                    Log.d(TAG, "Sub3cp" + sub3cp + sub3);
                    String sub4 = dataSnapshot.child(reg_no).child("S6").child("6022").getValue().toString();
                    int sub4cp = Calc(sub4);
                    Log.d(TAG, "Sub4cp" + sub4cp + sub4);
                    String sub5 = dataSnapshot.child(reg_no).child("S6").child("6023").getValue().toString();
                    int sub5cp = Calc(sub5);
                    Log.d(TAG, "Sub5cp" + sub5cp + sub5);
                    String sub6 = dataSnapshot.child(reg_no).child("S6").child("6027").getValue().toString();
                    int sub6cp = Calc(sub6);
                    Log.d(TAG, "Sub6cp" + sub6cp + sub6);
                    String sub7 = dataSnapshot.child(reg_no).child("S6").child("6028").getValue().toString();
                    int sub7cp = Calc(sub7);
                    String sub8 = dataSnapshot.child(reg_no).child("S6").child("6029").getValue().toString();
                    ...
                    String cp3 = dataSnapshot.child("CreditS6").child("6021").getValue().toString();
                    String cp4 = dataSnapshot.child("CreditS6").child("6022").getValue().toString();
                    String cp5 = dataSnapshot.child("CreditS6").child("6023").getValue().toString();
                    String cp6 = dataSnapshot.child("CreditS6").child("6027").getValue().toString();
                    String cp7 = dataSnapshot.child("CreditS6").child("6028").getValue().toString();
                    String cp8 = dataSnapshot.child("CreditS6").child("6029").getValue().toString();
                    ...
                    if (sub1cp >= 0 && sub2cp >= 0 && sub3cp >= 0 && sub4cp >= 0 && sub5cp >= 0 && sub6cp >= 0 && sub7cp>=0&& sub8cp>=0) {
                        ...
                        database.child("Result").child("Mechanical").child(reg_no).child("S6").child("ttlsscore").setValue(ttl_score);

                        database.child("Result").child("Mechanical").child(reg_no).child("S6").child("SGPA").setValue(finalresult);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Grades.contains(s1) && Grades.contains(s2) && Grades.contains(s3) && Grades.contains(s4) && Grades.contains(s5) && Grades.contains(s6)&& Grades.contains(s7)&& Grades.contains(s8)) {
                    Log.d(TAG, "Inside");
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c1).setValue(s1);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c2).setValue(s2);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c3).setValue(s3);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c4).setValue(s4);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c5).setValue(s5);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c6).setValue(s6);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c7).setValue(s7);
                    database.child("Result").child("Mechanical").child(reg_no).child("S6").child(c8).setValue(s8);
